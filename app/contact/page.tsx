                ...
                <div className="space-y-5 sm:space-y-6">
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+919876543210" className="text-txt-muted hover:text-accent text-xs sm:text-sm mt-0.5 block transition-colors">
                        +91 98765 43210
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@novaframes.agency" className="text-txt-muted hover:text-accent text-xs sm:text-sm mt-0.5 block transition-colors break-all">
                        hello@novaframes.agency
                      </a>
                    </div>
                  </div>
