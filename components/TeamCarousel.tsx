  ...
  return (
    <section id="team-carousel" className="py-16 sm:py-24 bg-surface-alt relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        ...
        <div
          ref={scrollRef}
          className="flex gap-4 sm:gap-6 mt-8 sm:mt-12 overflow-x-auto snap-x snap-mandatory scroll-smooth hide-scrollbar pb-6 sm:pb-8 -mx-4 px-4 sm:mx-0 sm:px-0 carousel-track"
        >
